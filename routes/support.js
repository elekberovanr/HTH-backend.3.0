...
router.post('/', verifyToken, upload.single('image'), controller.sendSupportMessage);
...
router.post('/admin/:userId', verifyToken, isAdmin, upload.single('image'), controller.sendSupportMessage);
